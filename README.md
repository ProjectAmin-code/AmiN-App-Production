...
This repository now includes the student sync platform:

1. Flutter mobile app (`/lib`)
2. Next.js admin dashboard (`/dashboard`)
...
Legacy snapshot payload compatibility is still retained through the server API.
